...
- [x] 1.1 Update `DeleteGoalUseCase` constructor in `app/src/main/java/com/assabloy/livvi/streakdays/feature/details/domain/usecase/DeleteGoalUseCase.kt` to inject `WidgetUpdater`.
...
- [x] 2.1 Update the empty state text in `StreakDaysWidgetContent` within `app/src/main/java/com/assabloy/livvi/streakdays/feature/widget/streak/presentation/ui/StreakDaysWidget.kt` to "Você não tem nenhum objetivo ainda".
